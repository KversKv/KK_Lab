...
- **关联**：[AI_Assist.md §4.1](../NewFT/AI_Assist.md)、[AI_AssistPlan.md 阶段 0/1](../NewFT/AI_AssistPlan.md)
- **参考图**：`docs/ai/NewFT/20260617-161442.jpg`
...
方案 B 列入 [AI_AssistPlan.md 阶段 5](../NewFT/AI_AssistPlan.md)（体验优化，可选项），不在第一版强推。
