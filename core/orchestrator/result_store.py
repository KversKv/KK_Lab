"""Orchestrator result model and export helpers."""
...
def build_default_result_path(
    ...
    *,
    ...
    output_dir = os.path.join(project_root, "Results", "orchestrator", ts)
    return os.path.join(output_dir, f"orchestrator_{profile}_{ts}.{extension}")
