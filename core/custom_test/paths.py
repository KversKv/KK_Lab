"""Path helpers for Custom Test user data."""
...
def get_primary_template_dir() -> str:
    return os.path.join(project_root(), "userdata", "custom_test_templates")


def get_legacy_template_dir() -> str:
    return os.path.join(project_root(), "ui", "pages", "custom_test", "templates")
...
def get_recent_sequences_path() -> str:
    return os.path.join(project_root(), "userdata", "custom_test_recent.json")
