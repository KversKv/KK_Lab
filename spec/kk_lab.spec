...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'core.instruments.connection_hub',
        'chips',
        ...
        'ui.pages.pmu',
        'ui.pages.pmu.pmu_1811_ui',
        'ui.pages.pmu.pmu_1860_ui',
        'ui.pages.chamber',
        ...
        'ui.pages.consumption_test.widgets',
        'ui.pages.consumption_test.view_config',
        'ui.pages.consumption_test.view_results',
        'core.consumption_test',
        'core.consumption_test.consumption_controller',
        'core.consumption_test.workers',
        'core.consumption_test.workers.common',
        'core.consumption_test.workers.download_worker',
        'core.consumption_test.workers.chip_check_worker',
        'core.consumption_test.workers.consumption_worker',
        'core.consumption_test.workers.force_worker',
        'core.consumption_test.workers.auto_test_worker',
        'Bes_I2CIO_Interface',
        'i2c_interface_x64',
        'i2c_demo_x64',
        'efuse_script_caller',
