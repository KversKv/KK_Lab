...
a = Analysis(
    ...
    datas=[
        ...
        # Include lib/download_tools directory (dldtool.exe, programmer bins, download script)
    ...
    hiddenimports=[
        ...
        'ui.styles.scrollbar',
        'ui.styles.button',
        'ui.styles.start_sequence',
        'ui.styles.execution_logs_module_frame',
        'ui.styles.n6705c_module_frame',
        'ui.styles.oscilloscope_module_frame',
        'ui.styles.chamber_module_frame',
        'ui.styles.serialCom_module_frame',
        'ui.pages',
