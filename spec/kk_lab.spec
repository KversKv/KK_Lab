...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'ui.pages.power.n6705c_analyser_ui',
        ...
        'ui.pages.pmu.gpadc_test_ui',
        'ui.pages.pmu.clk_test_ui',
        'ui.pages.chamber',
        'ui.pages.chamber.vt6002_chamber_ui',
        'ui.pages.charger',
        'ui.pages.charger.charger_test_ui',
        'ui.pages.charger.config_traverse_test',
        'ui.pages.charger.iterm_test',
        'ui.pages.charger.regulation_voltage_ui',
        'ui.pages.charger.status_register_test',
        'ui.pages.test',
