...
class MSO64BUI(QWidget):
    ...
    def _create_measure_tab(self):
        ...
        self.measure_channel_combo = DarkComboBox(bg="#32353a", border="#555")
        ...
        self.measure_type_combo = DarkComboBox(bg="#32353a", border="#555")
    ...
    def _create_display_tab(self):
        ...
        self.trigger_source_combo = DarkComboBox(bg="#32353a", border="#555")
        ...
        self.trigger_type_combo = DarkComboBox(bg="#32353a", border="#555")
