...
class PMUOSCPUI(QWidget):
    ...
    def _create_layout(self):
        ...
        title.setStyleSheet("font-size: 24px; font-weight: 700; color: #f5f7ff;")
        subtitle = QLabel("Configure and execute OSCP validation sequences.")
        subtitle.setStyleSheet("font-size: 11px; color: #8fa7d6;")
        ...
        self.instrument_info_label.setStyleSheet("color:#d7e3ff; font-weight:600;")

        self.connection_status_label = QLabel("Disconnected")
        self.connection_status_label.setStyleSheet("color:#7e8fb8;")

        self.connect_btn = QPushButton("Connect")
        self.disconnect_btn = QPushButton("Disconnect")
        self.disconnect_btn.setProperty("role", "outline")

        top_layout.addWidget(QLabel("Resource"), 0, 0)
