...
class PMUIsGainUI(QWidget):
    ...
    def _create_layout(self):
        ...
        self.result_table.setHorizontalHeaderLabels(["STEP", "REGISTER VALUE", "IS_GAIN"])
    ...
    def add_result_row(self, step, reg_value, is_gain):
    ...
    def update_test_result(self, result):
        ...
        elif any(k in result for k in ("step", "reg_value", "is_gain")):
            self.add_result_row(
                result.get("step", ""),
