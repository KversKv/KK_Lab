...
class GPADCTestUI(QWidget):
    ...
    def _calibration_data(self, result):
        ...
        print(f'{"voltage":>10s} {"mean_raw":>10s} {"mean_cali":>12s} {"min_cali":>12s} {"max_cali":>12s}')
        for i in range(n):
            print(f'{adc_raw_data[i]:>10.4f} {adc_mean[i]:>10.3f} {mean_cali[i]:>12.6f} {adc_min_cali[i]:>12.6f} {adc_max_cali[i]:>12.6f}')
    ...
    def gpadc_temp_consistency_test(
        ...
        print("\n===== TEMP CONSISTENCY TEST 校准结果 (Mean Cali) =====")
        print("Temp\\Voltage  " + vol_header)
        for i, t in enumerate(temp_list):
        ...
        print("\n===== TEMP CONSISTENCY TEST 校准结果 (Min Cali) =====")
        print("Temp\\Voltage  " + vol_header)
        for i, t in enumerate(temp_list):
        ...
        print("\n===== TEMP CONSISTENCY TEST 校准结果 (Max Cali) =====")
        print("Temp\\Voltage  " + vol_header)
        for i, t in enumerate(temp_list):
