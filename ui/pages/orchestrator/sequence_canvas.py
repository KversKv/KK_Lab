...
from core.orchestrator.paths import get_primary_template_dir, record_recent_sequence
from core.orchestrator.snapshot import clone_node
from ui.pages.orchestrator.sequence_io import load_sequence_file, save_sequence_file
from ui.pages.orchestrator.node_metadata import filter_selectable_ops
...
class SequenceCanvas(QWidget):
    ...
    def add_node(self, node: BaseNode, parent_item: Optional[QTreeWidgetItem] = None,
        ...
        from core.orchestrator.nodes.logic_nodes import IfBlock
