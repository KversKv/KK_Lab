"""Orchestrator results panel: logs, data table, chart and visible export."""
...
class ResultPanel(QWidget):
    """Bottom panel for Orchestrator run output."""
    ...
    def export_visible_table(self) -> None:
        ...
        default_name = f"orchestrator_{datetime.now().strftime('%Y%m%d_%H%M%S')}.xlsx"
