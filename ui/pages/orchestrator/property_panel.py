...
_CHECK_ICON = _os.path.join(
    _get_resource_base(),
    "resources", "pages", "orchestrator_SVGs", "check.svg"
).replace("\\", "/")
...
class PropertyPanel(QWidget):
    ...
    def _rebuild_form(self) -> None:
        ...
        from core.orchestrator.nodes.logic_nodes import IfBlock, IfBranch
        target_uid = None
    ...
    def _build_record_data_editor(self, node: BaseNode, card_layout: QVBoxLayout) -> None:
        ...
        from ui.pages.orchestrator.record_data_editor import RecordDataPointEditor
