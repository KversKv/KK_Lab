...
# -*- coding: utf-8 -*-
"""
PMU测试主UI组件 - 整合DCDC Efficiency、Output Voltage和Threshold子页面
"""
...
class PMUTestUI(QWidget):
    ...
    def _create_layout(self):
        ...
        # 系统控制区域
        system_control_group = QGroupBox("系统控制")
        system_control_layout = QHBoxLayout()
        system_control_layout.setSpacing(10)
        system_control_layout.setContentsMargins(20, 15, 20, 15)
        
        self.calibrate_btn = QPushButton("校准系统")
        self.reset_btn = QPushButton("重置系统")
        self.abort_all_btn = QPushButton("终止所有测试")
        self.abort_all_btn.setStyleSheet("background-color: #e53935; color: white;")
        
        system_control_layout.addWidget(self.calibrate_btn)
        system_control_layout.addWidget(self.reset_btn)
        system_control_layout.addStretch()
        system_control_layout.addWidget(self.abort_all_btn)
    ...
    def update_test_result(self, test_type, result):
        ...
        # 更新系统状态
        self.system_status_label.setText("测试完成")
